...
form.addEventListener("submit", (event) => {
    ...
    donatePlant(plant.value,color.value,notes.value); // uses call back function from generatePlant.js and add .value to arguments in order to get the values inputted by user and not just the html code
